# A7C3 Core Toolkit — Statement Catalog

This proof-free catalog contains the statements of Spare Parts with broad, recurring research utility. Ordinary A7C3 initialization should skim this file as the default reusable theorem shelf. The statements below are copied from the former flat `A7C3/SPARE_PARTS/STATEMENTS.md` catalog.
