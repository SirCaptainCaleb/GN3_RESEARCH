...
The project deliberately separates live search, certification, and canonical placement. Slack may contain provisional or certified mathematics, the research tree compresses the current search, audit establishes correctness of exact targets, and the Vice Director decides which certified mathematics has earned a durable role in the proof spine or toolkit.
