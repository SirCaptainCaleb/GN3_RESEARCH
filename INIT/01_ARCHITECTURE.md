...
The project deliberately separates live search, structural synthesis, certification, and canonical placement. Slack may contain provisional or certified mathematics; structural synthesis reconstructs the best combined mathematical picture and abstraction hierarchy; the research tree records the compressed live search that results; audit establishes correctness of exact targets; and the Vice Director separately decides which certified mathematics has earned a durable role in the proof spine or toolkit.

## Maintenance

Keep the numbered init set small, explicit, and nonredundant. When a policy belongs to mathematical writing, research operation, structural synthesis, or audit, put it in the corresponding numbered file rather than duplicating it here. When a newer explicit rule conflicts with older wording elsewhere, the newer rule should be consolidated into the appropriate numbered init document and the duplicate removed.
